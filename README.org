...
sprout is a small raytracing renderer written in C++. I work on it to learn about/experiment with physically based rendering and global illumination.
...
At the moment the most advanced integrator is a uni-directional path tracer  with forward prediction and multiple importance sampling. Area-lights and HDRI-lights are supported.
...
A combination of a rudimentary light tracer and photon mapper can assist with caustic paths.
