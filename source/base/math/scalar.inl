...
static inline Simd1f operator+(float a, Simd1f_p b) {
    __m128 const s = _mm_load_ss(&a);

    return _mm_add_ss(s, b.v);
}

static inline Simd1f operator+(Simd1f_p a, Simd1f_p b) {
...
static inline Simd1f operator-(__m128 a, Simd1f_p b) {
...
static inline Simd1f operator-(Simd1f_p s) {
    return _mm_sub_ss(simd::Zero, s.v);
}

static inline Simd1f sqrt(Simd1f_p x) {
