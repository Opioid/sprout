...
SU_GLOBALCONST(Vector_f32) Cephes_SQRTHF = {{{ 0.707106781186547524f, 0.707106781186547524f, 0.707106781186547524f, 0.707106781186547524f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p0 = {{{ 7.0376836292E-2f, 7.0376836292E-2f, 7.0376836292E-2f, 7.0376836292E-2f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p1 = {{{ -1.1514610310E-1f, -1.1514610310E-1f, -1.1514610310E-1f, -1.1514610310E-1f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p2 = {{{ 1.1676998740E-1f, 1.1676998740E-1f, 1.1676998740E-1f, 1.1676998740E-1f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p3 = {{{ -1.2420140846E-1f, -1.2420140846E-1f, -1.2420140846E-1f, -1.2420140846E-1f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p4 = {{{ +1.4249322787E-1f, +1.4249322787E-1f, +1.4249322787E-1f, +1.4249322787E-1f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p5 = {{{ -1.6668057665E-1f, -1.6668057665E-1f, -1.6668057665E-1f, -1.6668057665E-1f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p6 = {{{ +2.0000714765E-1f, +2.0000714765E-1f, +2.0000714765E-1f, +2.0000714765E-1f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p7 = {{{ -2.4999993993E-1f, -2.4999993993E-1f, -2.4999993993E-1f, -2.4999993993E-1f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_p8 = {{{ +3.3333331174E-1f, +3.3333331174E-1f, +3.3333331174E-1f, +3.3333331174E-1f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_q1 = {{{ -2.12194440e-4f, -2.12194440e-4f, -2.12194440e-4f, -2.12194440e-4f }}};
SU_GLOBALCONST(Vector_f32) Cephes_log_q2 = {{{ 0.693359375f, 0.693359375f, 0.693359375f, 0.693359375f }}};
