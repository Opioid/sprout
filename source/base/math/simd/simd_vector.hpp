...
Vector SU_CALLCONV load_vec3(const Vector3<float>& source);
Vector SU_CALLCONV load_vec3(const Vector3f_a& source);
...
void SU_CALLCONV store_vec3(Vector3<float>& destination, FVector v);
void SU_CALLCONV store_vec3(Vector3f_a& destination, FVector v);
