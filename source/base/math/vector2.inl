...
template<typename T>
static Vector2<T> operator/(Vector2<T> a, T s) {
...
template<typename T>
static bool operator==(Vector2<T> a, Vector2<T> b) {
...
template<typename T>
static Vector2<T> operator*(T s, Vector2<T> v) {
...
template<typename T>
static T length(Vector2<T> v)  {
	return std::sqrt(dot(v, v));
}

template<typename T>
static T squared_length(Vector2<T> v) {
	return dot(v, v);
}
...
template<typename T>
static Vector2<T> reciprocal(Vector2<T> v) {
...
template<typename T>
static Vector2<T> saturate(Vector2<T> v) {
	return Vector2<T>(std::min(std::max(v[0], T(0)), T(1)),
					  std::min(std::max(v[1], T(0)), T(1)));
}

template<typename T>
static Vector2<T> lerp(Vector2<T> a, Vector2<T> b, T t) {
	T u = T(1) - t;
	return u * a + t * b;
}

template<typename T>
static Vector2<T> round(Vector2<T> v){
