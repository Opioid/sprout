...
inline constexpr Vector3f_a Vector4f_a::xyz() const { return Vector3f_a(v); }

inline constexpr float Vector4f_a::operator[](uint32_t i) const { return v[i]; }

inline constexpr float& Vector4f_a::operator[](uint32_t i) { return v[i]; }

inline constexpr Vector4f_a Vector4f_a::identity() { return Vector4f_a(0.f, 0.f, 0.f, 0.f); }
...
inline constexpr Vector2<int32_t> Vector4i_a::xy() const { return Vector2<int32_t>(v[0], v[1]); }

inline constexpr Vector2<int32_t> Vector4i_a::zw() const { return Vector2<int32_t>(v[2], v[3]); }

inline constexpr int32_t Vector4i_a::operator[](uint32_t i) const { return v[i]; }

inline constexpr int32_t& Vector4i_a::operator[](uint32_t i) { return v[i]; }
