...
inline Matrix3 SU_CALLCONV load_float3x3(Matrix3x3f_a const& source) {
    return Matrix3{
        {_mm_load_ps(source.r[0].v), _mm_load_ps(source.r[1].v), _mm_load_ps(source.r[2].v)}};
}

inline Matrix4 SU_CALLCONV load_float4x4(Matrix4x4f_a const& source) {
    return Matrix4{{_mm_load_ps(source.r[0].v), _mm_load_ps(source.r[1].v),
                    _mm_load_ps(source.r[2].v), _mm_load_ps(source.r[3].v)}};
}
