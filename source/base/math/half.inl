...
static inline uint16_t rounded(int32_t value, int32_t g, int32_t s) {
...
static inline ushort3 float_to_half(float3_p f) {
    return ushort3(float_to_half(f[0]), float_to_half(f[1]), float_to_half(f[2]));
}

static inline ushort3 float_to_half(packed_float3_p f) {
    return ushort3(float_to_half(f[0]), float_to_half(f[1]), float_to_half(f[2]));
}
...
static inline float half_to_float2(uint16_t h) {
...
static inline float3 half_to_float(ushort3 h) {
    alignas(16) uint32_t const i[4] = {uint32_t(h[0]) | uint32_t(h[1]) << 16, uint32_t(h[2]), 0, 0};
