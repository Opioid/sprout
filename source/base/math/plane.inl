...
inline Plane create(FVector3f_a normal, float d) {
	return Plane(normal, d);
}

inline Plane create(FVector3f_a normal, FVector3f_a point) {
	return Plane(normal[0], normal[1], normal[2], -dot(normal, point));
}

inline Plane create(FVector3f_a v0, FVector3f_a v1, FVector3f_a v2) {
