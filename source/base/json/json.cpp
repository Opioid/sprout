...
math::float2 read_float2(const rapidjson::Value& value) {
	return math::float2(float(value[0u].GetDouble()), float(value[1].GetDouble()));
}

math::float3 read_float3(const rapidjson::Value& value) {
	return math::float3(float(value[0u].GetDouble()), float(value[1].GetDouble()), float(value[2].GetDouble()));
}

math::float4 read_float4(const rapidjson::Value& value) {
	return math::float4(float(value[0u].GetDouble()), float(value[1].GetDouble()), float(value[2].GetDouble()), float(value[3].GetDouble()));
}
