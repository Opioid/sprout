...
int2 read_int2(const rapidjson::Value& value, const std::string& name, int2 default_value);

uint2 read_uint2(const rapidjson::Value& value);
uint2 read_uint2(const rapidjson::Value& value, const std::string& name, uint2 default_value);
