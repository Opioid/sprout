...
Document_ptr parse_insitu(char* buffer, std::string& error);
Document_ptr parse(std::string_view buffer, std::string& error);
Document_ptr parse(std::istream& stream, std::string& error);
