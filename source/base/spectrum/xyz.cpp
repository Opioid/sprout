...
// CIE XYZ color matching functions from 'http://staff.science.uva.nl/~rein/mp/files/ciexyz31_1.txt'
float const CIE_X_360_830_1nm[CIE_XYZ_Num] = {
...
float const CIE_Y_360_830_1nm[CIE_XYZ_Num] = {
...
float const CIE_Z_360_830_1nm[CIE_XYZ_Num] = {0.0006061000f,
                                              0.0006808792f,
                                              0.0007651456f,
                                              0.0008600124f,
                                              0.0009665928f,
...
float const CIE_Wavelengths_360_830_1nm[CIE_XYZ_Num] = {
    60,  361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374, 375, 376, 377, 378,
