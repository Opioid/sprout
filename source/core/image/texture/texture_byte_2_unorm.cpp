...
float Byte2_unorm::at_1(int32_t i) const {
...
float4 Byte2_unorm::gather_1(int4 const& xy_xy1) const {
    ...
    return float4(
        encoding::cached_unorm_to_float(v[0][0]), encoding::cached_unorm_to_float(v[1][0]),
        encoding::cached_unorm_to_float(v[2][0]), encoding::cached_unorm_to_float(v[3][0]));
}
