...
float4 Float1::at_4(int32_t x, int32_t y) const noexcept {
...
float4 Float1::at_element_4(int32_t x, int32_t y, int32_t element) const noexcept {
...
float4 Float1::at_4(int32_t x, int32_t y, int32_t z) const noexcept {
