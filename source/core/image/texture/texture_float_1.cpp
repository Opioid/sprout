...
float3 Float_1::at_3(int32_t i) const {
...
float4 Float_1::gather_1(const int4& xy_xy1) const {
	float v[4];
...
void Float_1::gather_2(const int4& xy_xy1, float2 c[4]) const {
	float v[4];
	image_.gather(xy_xy1, v);
...
void Float_1::gather_3(const int4& xy_xy1, float3 c[4]) const {
	float v[4];
	image_.gather(xy_xy1, v);
