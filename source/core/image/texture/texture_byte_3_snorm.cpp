...
float4 Byte_3_snorm::gather_1(int4 xy_xy1) const {
	...
	return float4(encoding::cached_snorm_to_float(v00[0]),
				  encoding::cached_snorm_to_float(v01[0]),
				  encoding::cached_snorm_to_float(v10[0]),
				  encoding::cached_snorm_to_float(v11[0]));
}
...
void Byte_3_snorm::gather_2(int4 xy_xy1, float2 c[4]) const {
	...
	c[0] = float2(encoding::cached_snorm_to_float(v00[0]),
				  encoding::cached_snorm_to_float(v00[1]));

	c[1] = float2(encoding::cached_snorm_to_float(v01[0]),
				  encoding::cached_snorm_to_float(v01[1]));

	c[2] = float2(encoding::cached_snorm_to_float(v10[0]),
				  encoding::cached_snorm_to_float(v10[1]));

	c[3] = float2(encoding::cached_snorm_to_float(v11[0]),
				  encoding::cached_snorm_to_float(v11[1]));
}
...
void Byte_3_snorm::gather_3(int4 xy_xy1, float3 c[4]) const {
	...
	c[0] = float3(encoding::cached_snorm_to_float(v00[0]),
				  encoding::cached_snorm_to_float(v00[1]),
				  encoding::cached_snorm_to_float(v00[2]));

	c[1] = float3(encoding::cached_snorm_to_float(v01[0]),
				  encoding::cached_snorm_to_float(v01[1]),
				  encoding::cached_snorm_to_float(v01[2]));

	c[2] = float3(encoding::cached_snorm_to_float(v10[0]),
				  encoding::cached_snorm_to_float(v10[1]),
				  encoding::cached_snorm_to_float(v10[2]));

	c[3] = float3(encoding::cached_snorm_to_float(v11[0]),
				  encoding::cached_snorm_to_float(v11[1]),
				  encoding::cached_snorm_to_float(v11[2]));
}
