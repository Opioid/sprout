...
static inline float3 bilinear(f_float3 c00, f_float3 c10,
							  f_float3 c01, f_float3 c11,
							  float s, float t) {
	const float _s = 1.f - s;
	const float _t = 1.f - t;
...
static inline float4 bilinear(f_float4 c00, f_float4 c10,
							  f_float4 c01, f_float4 c11,
							  float s, float t) {
	const float _s = 1.f - s;
	const float _t = 1.f - t;
