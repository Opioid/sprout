#ifndef SU_CORE_IMAGE_TEXTURE_FLOAT4_HPP
#define SU_CORE_IMAGE_TEXTURE_FLOAT4_HPP
...
class Float4 {
  public:
    Float4(image::Float4 const& image);

    image::Float4 const& image() const;
