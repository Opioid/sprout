...
float2 Texture_2D_float_3::at_2(int32_t x, int32_t y) const {
	return image_.load(x, y).xy;
}

float3 Texture_2D_float_3::at_3(int32_t x, int32_t y) const {
//	return image_.load(x, y);

	return float3(image_.at(x, y));
}

float4 Texture_2D_float_3::at_4(int32_t x, int32_t y) const {
...
float2 Texture_2D_float_3::at_2(int32_t x, int32_t y, int32_t element) const {
	return image_.at(x, y, element).xy;
}

float3 Texture_2D_float_3::at_3(int32_t x, int32_t y, int32_t element) const {
//	return image_.at(x, y, element);

	return float3(image_.at(x, y, element));
}

float4 Texture_2D_float_3::at_4(int32_t x, int32_t y, int32_t element) const {
