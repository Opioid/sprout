...
float4 Float_3::gather_1(const int4& xy_xy1) const {
	packed_float3 v[4];
...
void Float_3::gather_2(const int4& xy_xy1, float2 c[4]) const {
	packed_float3 v[4];
	image_.gather(xy_xy1, v);
...
void Float_3::gather_3(const int4& xy_xy1, float3 c[4]) const {
/*	packed_float3 v[4];
	image_.gather(xy_xy1, v);
