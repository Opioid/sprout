...
float4 Byte1_unorm::gather_1(int4 const& xy_xy1) const {
    ...
    return float4(encoding::cached_unorm_to_float(v[0]), encoding::cached_unorm_to_float(v[1]),
                  encoding::cached_unorm_to_float(v[2]), encoding::cached_unorm_to_float(v[3]));
}
