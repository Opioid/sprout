...
class Adapter {
  public:
    ...
    float2 sample_2(Worker const& worker, Sampler_3D const& sampler, float3_p uvw,
                    float3_p r) const;
    float3 sample_3(Worker const& worker, Sampler_3D const& sampler, float3_p uvw,
                    float3_p r) const;
    float4 sample_4(Worker const& worker, Sampler_3D const& sampler, float3_p uvw,
                    float3_p r) const;
