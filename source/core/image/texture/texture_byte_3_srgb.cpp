...
float4 Byte_3_sRGB::gather_1(int4 xy_xy1) const {
	...
	return float4(encoding::srgb_to_float(v00.x),
				  encoding::srgb_to_float(v01.x),
				  encoding::srgb_to_float(v10.x),
				  encoding::srgb_to_float(v11.x));
}
...
void Byte_3_sRGB::gather_2(int4 xy_xy1, float2 c[4]) const {
	...
	c[0] = float2(encoding::srgb_to_float(v00.x),
				  encoding::srgb_to_float(v00.y));

	c[1] = float2(encoding::srgb_to_float(v01.x),
				  encoding::srgb_to_float(v01.y));

	c[2] = float2(encoding::srgb_to_float(v10.x),
				  encoding::srgb_to_float(v10.y));

	c[3] = float2(encoding::srgb_to_float(v11.x),
