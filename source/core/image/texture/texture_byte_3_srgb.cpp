...
float3 Byte_3_sRGB::at_3(int32_t i) const {
...
float4 Byte_3_sRGB::gather_1(const int4& xy_xy1) const {
	byte3 v[4];
...
void Byte_3_sRGB::gather_2(const int4& xy_xy1, float2 c[4]) const {
	byte3 v[4];
	image_.gather(xy_xy1, v);
...
void Byte_3_sRGB::gather_3(const int4& xy_xy1, float3 c[4]) const {
/*	byte3 v[4];
	image_.gather(xy_xy1, v);
