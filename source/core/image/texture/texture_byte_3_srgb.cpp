...
float4 Byte3_sRGB::at_4(int32_t x, int32_t y) const {
    ...
    return float4(encoding::cached_srgb_to_float(value[0]),
                  encoding::cached_srgb_to_float(value[1]),
                  encoding::cached_srgb_to_float(value[2]), 1.f);
}
...
float4 Byte3_sRGB::gather_1(int4 const& xy_xy1) const {
    ...
    return float4(encoding::cached_srgb_to_float(v[0][0]), encoding::cached_srgb_to_float(v[1][0]),
                  encoding::cached_srgb_to_float(v[2][0]), encoding::cached_srgb_to_float(v[3][0]));
}
