...
const Image::Description& Image::description() const { return description_; }

int2 Image::dimensions2() const { return description_.dimensions.xy(); }

int32_t Image::area() const { return area_; }

int32_t Image::volume() const { return volume_; }
