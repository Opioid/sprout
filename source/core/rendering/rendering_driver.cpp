...
Driver::Driver(take::Take& take, Scene& scene, thread::Pool& thread_pool,
    ...
    : scene_(scene),
      ...
      workers_(memory::construct_aligned<Camera_worker>(thread_pool.num_threads(), tiles_)),
      ...
      photon_map_(take.photon_settings.num_photons, take.photon_settings.search_radius,
                  take.photon_settings.merge_radius, take.photon_settings.indirect_radius_factor,
