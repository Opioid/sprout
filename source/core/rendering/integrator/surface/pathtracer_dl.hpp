...
class alignas(64) Pathtracer_DL final : public Integrator {
  public:
    ...
    Pathtracer_DL(Settings const& settings, uint32_t max_samples_per_pixel, bool progressive);
...
class Pathtracer_DL_pool final : public Typed_pool<Pathtracer_DL, Integrator> {
  public:
