#ifndef SU_CORE_RENDERING_INTEGRATOR_SURFACE_SUB_MULTIPLE_SCATTERING2_HPP
#define SU_CORE_RENDERING_INTEGRATOR_SURFACE_SUB_MULTIPLE_SCATTERING2_HPP
...
class alignas(64) Multiple_scattering2 : public Integrator {
...
public:
    ...
    Multiple_scattering2(rnd::Generator& rng, const take::Settings& take_settings/*,
...
class Multiple_scattering2_factory : public Factory {

public:

	Multiple_scattering2_factory(const take::Settings& take_settings, uint32_t num_integrators);

	~Multiple_scattering2_factory();

	virtual Integrator* create(uint32_t id, rnd::Generator& rng) const override final;

private:

	Multiple_scattering2* integrators_;
