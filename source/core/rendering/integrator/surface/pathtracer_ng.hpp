...
class alignas(64) Pathtracer_NG final : public Integrator {
...
public:
	...
	Pathtracer_NG_factory(const take::Settings& take_settings, uint32_t num_integrators,
...
private:
	...
	Pathtracer_NG* integrators_;

	Pathtracer_NG::Settings settings_;
};
