...
bool Null::sample(uint32_t /*part*/, uint32_t /*variant*/, Transformation const& /*trafo*/,
...
float Null::pdf(uint32_t /*variant*/, Ray const& /*ray*/, float3_p /*n*/,
                Intersection const& /*isec*/, Transformation const& /*trafo*/, float /*area*/,
                bool /*two_sided*/, bool /*total_Null*/) const {
    return 0.f;
}
