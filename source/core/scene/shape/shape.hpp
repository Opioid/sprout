...
public:
	...
	virtual void sample(uint32_t part, const entity::Composed_transformation& transformation, float area,
						const math::vec3& p, math::float2 uv, Sample& sample) const = 0;

	virtual void sample(uint32_t part, const entity::Composed_transformation& transformation, float area,
						const math::vec3& p, const math::vec3& wi, Sample& sample) const = 0;
	...
	virtual float area(uint32_t part, const math::vec3& scale) const = 0;
