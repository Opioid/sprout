...
struct Shading_vertex_MTC {
    Shading_vertex_MTC(const packed_float3& n, const packed_float3& t, float2 uv) noexcept;
...
struct Vertex_MTC {
    Vertex_MTC(const packed_float3& p, const packed_float3& n, const packed_float3& t,
               float2 uv) noexcept;
