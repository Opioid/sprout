...
Data<Intersection_triangle, Shading_triangle>::Data()
    : num_triangles_(0),
      current_triangle_(0),
      intersection_triangles_(nullptr),
      shading_triangles_(nullptr) {}
...
template <typename Intersection_triangle, typename Shading_triangle>
void Data<Intersection_triangle, Shading_triangle>::interpolate_data(uint32_t index, float2 uv,
                                                                     float3& n, float3& t,
                                                                     float2& tc) const {
...
template <typename Intersection_triangle, typename Shading_triangle>
float Data<Intersection_triangle, Shading_triangle>::area(uint32_t index, float3_p scale) const {
