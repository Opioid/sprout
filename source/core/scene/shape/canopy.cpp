...
Canopy::Canopy() { aabb_.set_min_max(float3::identity(), float3::identity()); }
...
float Canopy::area(uint32_t /*part*/, f_float3 /*scale*/) const { return 2.f * math::Pi; }

bool Canopy::is_finite() const { return false; }

size_t Canopy::num_bytes() const { return sizeof(*this); }
