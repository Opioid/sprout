...
Celestial_disk::Celestial_disk() { aabb_.set_min_max(float3::identity(), float3::identity()); }
...
float Celestial_disk::uv_weight(float2 /*uv*/) const { return 1.f; }
...
bool Celestial_disk::is_finite() const { return false; }

size_t Celestial_disk::num_bytes() const { return sizeof(*this); }
