...
bool Celestial_disk::intersect(const Composed_transformation& transformation, const math::Oray& ray, const math::float2& /*bounds*/,
					   Intersection& intersection, float& hit_t) const {
	return false;
}

bool Celestial_disk::intersect_p(const Composed_transformation& transformation, const math::Oray& ray, const math::float2& /*bounds*/) const {
	return false;
}

void Celestial_disk::importance_sample(const Composed_transformation& transformation, const math::float3& p, sampler::Sampler& sampler, uint32_t sample_index,
