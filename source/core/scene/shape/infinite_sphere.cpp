...
Infinite_sphere::Infinite_sphere() { aabb_.set_min_max(float3::identity(), float3::identity()); }
...
float Infinite_sphere::area(uint32_t /*part*/, f_float3 /*scale*/) const { return 4.f * math::Pi; }

bool Infinite_sphere::is_finite() const { return false; }

size_t Infinite_sphere::num_bytes() const { return sizeof(*this); }
