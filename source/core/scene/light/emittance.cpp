...
void Emittance::set_luminous_flux(const float3& color, float value) {
	const float luminance = spectrum::luminance(color);
...
void Emittance::set_luminous_intensity(const float3& color, float value) {
	const float luminance = spectrum::luminance(color);
...
void Emittance::set_luminous_exitance(const float3& color, float value) {
	const float luminance = spectrum::luminance(color);
