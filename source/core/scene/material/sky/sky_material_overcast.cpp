...
Material_overcast::Material_overcast(Generic_sample_cache<Sample_overcast>& cache,
									 std::shared_ptr<image::texture::Texture_2D> mask,
									 const Sampler_settings& sampler_settings, bool two_sided) :
	material::Typed_material<Generic_sample_cache<Sample_overcast>>(cache, mask, sampler_settings, two_sided) {}
...
math::float3 Material_overcast::sample_emission(math::pfloat3 wi, math::float2 /*uv*/, float /*time*/,
