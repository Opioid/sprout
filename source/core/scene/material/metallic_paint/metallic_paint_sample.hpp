...
class Sample : public material::Sample {
  public:
    ...
    struct Base_layer : material::Sample::Layer {
        ...
        bxdf::Result evaluate(f_float3 wi, f_float3 wo, float3 const& h, float wo_dot_h) const;
    ...
    struct Flakes_layer : material::Sample::Layer {
        ...
        bxdf::Result evaluate(f_float3 wi, f_float3 wo, float3 const& h, float wo_dot_h,
                              float3& fresnel_result) const;

        void sample(f_float3 wo, sampler::Sampler& sampler, float3& fresnel_result,
