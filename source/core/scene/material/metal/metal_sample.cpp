...
void Sample_isotropic::sample(sampler::Sampler& sampler, bxdf::Sample& result) const {
	...
	const fresnel::Conductor conductor(layer_.ior_, layer_.absorption_);
	float const n_dot_wi = ggx::Isotropic::reflect(wo_, n_dot_wo, layer_, conductor,
												   sampler, result);
...
bxdf::Result Sample_anisotropic::evaluate(f_float3 wi) const {
	...
	const fresnel::Conductor conductor(layer_.ior_, layer_.absorption_);
	auto const ggx = ggx::Anisotropic::reflection(h, n_dot_wi, n_dot_wo, wo_dot_h,
												  layer_, conductor);
...
void Sample_anisotropic::sample(sampler::Sampler& sampler, bxdf::Sample& result) const {
	...
	const fresnel::Conductor conductor(layer_.ior_, layer_.absorption_);
	float const n_dot_wi = ggx::Anisotropic::reflect(wo_, n_dot_wo, layer_, conductor,
													 sampler, result);
	result.reflection *= n_dot_wi;
