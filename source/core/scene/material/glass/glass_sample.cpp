...
const material::Sample::Layer& Sample::base_layer() const { return layer_; }

bxdf::Result Sample::evaluate(f_float3 /*wi*/) const { return {float3::identity(), 0.f}; }
...
bool Sample::is_transmissive() const { return true; }
