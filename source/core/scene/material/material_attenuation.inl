#ifndef SU_CORE_SCENE_MATERIAL_ATTENUATION_INL
#define SU_CORE_SCENE_MATERIAL_ATTENUATION_INL
...
static inline void attenuation(float3 const& color, float distance, float3& absorption_coefficient,
