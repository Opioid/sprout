...
public:
	...
	struct Layer : material::Sample::Layer {
		...
		void diffuse_importance_sample(float3_p wo, sampler::Sampler& sampler,
									   bxdf::Result& result) const;

		void specular_importance_sample(float3_p wo, sampler::Sampler& sampler,
										bxdf::Result& result) const;

		void pure_specular_importance_sample(float3_p wo, sampler::Sampler& sampler,
											 bxdf::Result& result) const;
