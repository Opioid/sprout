...
size_t Material_subsurface::num_bytes() const { return sizeof(*this); }
...
void Material_subsurface::set_attenuation(float3 const& absorption_color,
  ...
  attenuation(absorption_color, scattering_color, distance, absorption_coefficient_,
              scattering_coefficient_);
...
float Material_subsurface::majorant_mu_t() const { return majorant_mu_t_; }
...
bool Material_subsurface::is_heterogeneous_volume() const { return density_map_.is_valid(); }

size_t Material_subsurface::sample_size() { return sizeof(Sample_subsurface); }
