...
math::float3 Sample_translucent::emission() const {
	return emission_;
}

math::float3 Sample_translucent::attenuation() const {
	return math::float3(100.f, 100.f, 100.f);
}

float Sample_translucent::ior() const {
	return 0.f;
}
...
bool Sample_translucent::is_pure_emissive() const {
	return false;
}

bool Sample_translucent::is_transmissive() const {
	return false;
}
