...
Result Clearcoat::evaluate(f_float3 wi, f_float3 wo, float3 const& h, float wo_dot_h,
    ...
    float3                          fresnel;
    auto const                      ggx =
        ggx::Isotropic::reflection(n_dot_wi, n_dot_wo, wo_dot_h, n_dot_h, layer, schlick, fresnel);
...
void Clearcoat::sample(f_float3 wo, float /*internal_ior*/, Layer const& layer,
    ...
    float const n_dot_wi =
        ggx::Isotropic::reflect(wo, n_dot_wo, layer, schlick, sampler, attenuation, result);
...
Result Thinfilm::evaluate(f_float3 wi, f_float3 wo, float3 const& h, float wo_dot_h,
    ...
    float3                           fresnel;
    auto const                       ggx =
        ggx::Isotropic::reflection(n_dot_wi, n_dot_wo, wo_dot_h, n_dot_h, layer, thinfilm, fresnel);
...
void Thinfilm::sample(f_float3 wo, float internal_ior, Layer const& layer,
    ...
    float const n_dot_wi =
        ggx::Isotropic::reflect(wo, n_dot_wo, layer, thinfilm, sampler, attenuation, result);
