...
inline Interface_stack::~Interface_stack() { memory::free_aligned(stack_); }
...
inline bool Interface_stack::empty() const { return 0 == index_; }

inline void Interface_stack::clear() { index_ = 0; }
